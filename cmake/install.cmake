...
if(WIN32)
    install(TARGETS ${APP_NAME} DESTINATION ${APP_NAME} COMPONENT ${APP_NAME})
    install(FILES nucleus.conf DESTINATION ${APP_NAME} RENAME ${APP_NAME}.conf COMPONENT ${APP_NAME})
else()
